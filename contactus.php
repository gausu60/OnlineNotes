	...
	<!--Navigation Bar-->  
      ...
      <div class="jumbotron" id="myContainer">
          ...
          <div class="container">
            ...
            <div class="form-group ">
              <a href="#Subscribe" data-toggle="modal" class="btn btn-info" id="subscribes">Subscribe</a>
            </div>
          </div>
          
      </div>
      <!--subscribes-->
      <div class="modal" id="Subscribe" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
      	...
      	<div class="modal" id="loginModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      		<div class="modal-dialog">
      			<div class="modal-content">
      				...
      				<div class="checkbox">
      					<label>
      						<input type="checkbox" name="rememberme" id="rememberme" class="pull-left">
                        Remember me 
