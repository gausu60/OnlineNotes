...
$message .= "http://mrgausu.offyoucode.co.uk/NotesApp/activatenewemail.php?email=" . urlencode($email) . "&newemail=" . urlencode($newemail) . "&key=$activationKey";
if(mail($newemail, 'Email Update for you Online Notes App', $message, 'From:'.'developer7860@gmail.com')){
