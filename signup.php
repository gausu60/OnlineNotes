...
$message .= "http://mrgausu.offyoucode.co.uk/NotesApp/activate.php?email=" . urlencode($email) . "&key=$activationKey";
if(mail($email, 'Confirm your Registration', $message, 'From:'.'developer7860@gmail.com')){
